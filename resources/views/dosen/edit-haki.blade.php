...
<head>
    ...
    <title>Edit HAKI | Repositori Dosen - Universitas Negeri Manado</title>
...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Edit HAKI</h1>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">
                        <i class="fas fa-copyright mr-2 text-purple-500"></i> HAKI
                    </h3>
                </div>
                <div class="px-6 py-4 space-y-6">
                    ...
                    @empty
                        <p class="text-gray-500">Tidak ada HAKI yang terdaftar.</p>
                    @endforelse
                </div>
            </div>
